...
def get_loader(args, datapath, listfile, mode="train"):
    if args.dataset_name == "dtu_yao":
        dataset = DtuDataset(datapath, listfile, mode, args.train_view, args.img_size, args.numdepth, args.interval_scale, args.view_shuffling)
        ...
        dataset = EvalDataset(datapath, listfile, mode, args.test_view, args.numdepth, args.interval_scale, args.inverse_depth,
                              max_h=args.max_h, max_w=args.max_w, fix_res=args.fix_res)
    elif args.dataset_name == "blendedmvs":
        dataset = BlendedMVSDataset(datapath, listfile, mode, args.train_view, args.numdepth, args.interval_scale, args.view_shuffling)
    else:
