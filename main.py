...
parser = argparse.ArgumentParser(description="MVSNet args")

#views
parser.add_argument("--train_view", type=int, default=5)
parser.add_argument("--test_view", type=int, default=5)

# network
parser.add_argument("--ndepths", type=int, nargs='+', default=[48, 32, 8])
parser.add_argument("--interval_ratio", type=float, nargs='+', default=[4, 1, 0.5])
...
parser.add_argument("--view_shuffling", action="store_true")
...
parser.add_argument('--filter_method', type=str, default='gipuma', choices=["gipuma", "pcd", "dypcd", "dypcd_dtu"], help="filter method")
parser.add_argument('--display', action='store_true', help='display depth images and masks')
# pcd or dypcd
parser.add_argument('--conf', type=float, nargs='+', default=[0.1, 0.15, 0.5], help='prob confidence, for pcd and dypcd')
